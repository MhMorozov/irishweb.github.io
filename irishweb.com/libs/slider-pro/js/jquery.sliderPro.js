	...
	SliderProSlide.prototype = {
		...
		_init: function() {
			...
			if ( this.$mainImage !== null ) {
				...
				this.$imageContainer = $( '<div class="sp-image-container col-6 order-2"></div>' ).prependTo( this.$slide );
		...
		_thumbnailsOnUpdate: function() {
			...
			if ( this.$thumbnails === null ) {
				if ( this.$slider.find( '.sp-thumbnails' ).length !== 0 ) {
					...
					this.$thumbnails = $( '<div class="sp-thumbnails row"></div>' ).appendTo( this.$thumbnailsContainer );
				}
			}
	...
	var Arrows = {
		...
		_arrowsOnUpdate: function() {
			...
			if ( this.settings.arrows === true && this.$arrows === null ) {
				...
				this.$previousArrow = $( '<a class="a-left"><div class="sp-arrow-bg sp-arrow-bg-left"></div></a>' ).appendTo( this.$arrows );
				this.$nextArrow = $( '<a class="a-right"><div class="sp-arrow-bg sp-arrow-bg-right"></div></a>' ).appendTo( this.$arrows );
